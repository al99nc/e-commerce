/*
  ...
  - The values [EN,AR,FR] on the enum `Locale` will be removed. If these variants are still used in the database, this will fail.

*/
-- AlterEnum
BEGIN;
CREATE TYPE "Locale_new" AS ENUM ('en', 'ar', 'fr');
